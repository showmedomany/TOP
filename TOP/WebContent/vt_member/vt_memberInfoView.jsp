		...
		<form method="post" action="not" name="memberInfoView" onsubmit="return false">
			<table>
				...
				<tr>
					...
					<th> * 비밀번호  </th>
					<td>
						<input class="input" type="password" name="passwd" maxlength="15" value="${memberData.passwd}">
					</td>
				</tr>
				<tr>	
					<th> * 비밀번호 확인	</th>			
					<td>
						<input class="input" type="password" name="repasswd" maxlength="15" value="${memberData.passwd}">					
					</td>
				</tr>
				<tr>
					<th>* 이름</th>
				...
				<tr>
					...
					<th>* 닉네임</th>
					<td>
					<input class="input" type="text" name="nickname" maxlength="20" value="${memberData.nickname }">
					<br>						
				</td>
				</tr>
				<tr>
				...
				<c:if test="${memberData.address != null }">
					...
					<tr>
						<td>
							<input class="input" type="text" name="detail_adr" value="${address[1] }" readonly="readonly"
								style="width:500px"placeholder = "나머지주소">
						</td>
					</tr>
				</c:if>
