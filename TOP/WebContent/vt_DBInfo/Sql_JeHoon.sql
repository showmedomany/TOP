...
insert into vt_exercise values(vt_exercise_seq.nextval, 1, '체스트 머신', '머신',
'* 운동 준비 자세 / 개요 * 
...
insert into vt_exercise values(vt_exercise_seq.nextval, 4, '버피 테스트', '맨몸운동',
'* 운동 준비 자세 / 개요 * 
...
insert into vt_inbody values(vt_inbody_seq.nextval, 'kimy', 22, 170, 'male', 90, 70, sysdate);
insert into vt_inbody values(vt_inbody_seq.nextval, 'jangb', 32, 160, 'male', 90, 70, sysdate);
