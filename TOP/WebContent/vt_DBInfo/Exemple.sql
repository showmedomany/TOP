...
insert into vt_notice_board values(vt_notice_board_seq.nextval, 'lees', '나는야 퉁퉁이' , 0, sysdate, '공지사항 테스트  쿠쿠쿠');
...
insert into vt_notice_board values(vt_notice_board_seq.nextval, 'lees', '뭐 쓰지' , 0, sysdate, '공지사항 테스트 쿠쿠쿠');
